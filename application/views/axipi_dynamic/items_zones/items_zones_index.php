...
<ul>
<li><a class="create" href="<?php echo base_url(); ?><?php echo $this->itm->itm_code; ?>/_create/?zon_id=<?php echo $result->zon_id; ?>"><?php echo $this->lang->line('create'); ?></a></li>
</ul>
<div class="display">
...
<tr>
<td><a href="<?php echo base_url(); ?><?php echo $this->itm->itm_code; ?>/_read/?zon_id=<?php echo $result->zon_id;?>&amp;itm_id=<?php echo $itm_zon->itm_id;?>"><?php echo $itm_zon->itm_title;?></a></td>
...
<th>
<a href="<?php echo base_url(); ?><?php echo $this->itm->itm_code; ?>/_update/?zon_id=<?php echo $result->zon_id;?>&amp;itm_id=<?php echo $itm_zon->itm_id;?>"><?php echo $this->lang->line('update'); ?></a>
<a href="<?php echo base_url(); ?><?php echo $this->itm->itm_code; ?>/_delete/?zon_id=<?php echo $result->zon_id;?>&amp;itm_id=<?php echo $itm_zon->itm_id;?>"><?php echo $this->lang->line('delete'); ?></a>
</th>
</tr>
<?php } ?>
