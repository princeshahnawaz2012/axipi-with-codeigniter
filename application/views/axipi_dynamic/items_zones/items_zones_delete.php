...
<ul>
<li><a href="<?php echo base_url(); ?><?php echo $this->itm->itm_code; ?>/_update/?zon_id=<?php echo $zon->zon_id; ?>&amp;itm_id=<?php echo $itm->itm_id; ?>"><?php echo $this->lang->line('update'); ?></a></li>
<li><a href="<?php echo base_url(); ?><?php echo $this->itm->itm_code; ?>/_read/?zon_id=<?php echo $zon->zon_id; ?>&amp;itm=<?php echo $itm->itm_id; ?>"><?php echo $this->lang->line('read'); ?></a></li>
...
<?php echo form_open(current_url().'?zon_id='.$zon->zon_id.'&amp;itm_id='.$itm->itm_id); ?>
