...
<ul>
<li><a href="<?php echo base_url(); ?><?php echo $this->itm->itm_code; ?>/_read/?sct_id=<?php echo $sct->sct_id; ?>"><?php echo $this->lang->line('read'); ?></a></li>
...
<?php echo form_open(current_url().'?sct_id='.$sct->sct_id); ?>
