...
<div class="filters">
<div><?php echo form_label($this->lang->line('per_code'), 'permissions_per_code'); ?><?php echo form_input('permissions_per_code', set_value('permissions_per_code', $this->session->userdata('permissions_per_code')), 'class="inputtext"'); ?></div>
