...
<ul>
<li><a href="<?php echo current_url(); ?>?a=update&amp;usr_id=<?php echo $usr->usr_id; ?>"><?php echo $this->lang->line('update'); ?></a></li>
...
<?php echo form_open(current_url().'?a=delete&amp;usr_id='.$usr->usr_id); ?>
