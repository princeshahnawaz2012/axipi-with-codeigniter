...
<ul>
<li><a href="<?php echo current_url(); ?>?a=update&amp;rel_id=<?php echo $rel->itm_id; ?>&amp;itm_id=<?php echo $itm->itm_id; ?>"><?php echo $this->lang->line('update'); ?></a></li>
<li><a href="<?php echo current_url(); ?>?a=read&amp;rel_id=<?php echo $rel->itm_id; ?>&amp;itm=<?php echo $itm->itm_id; ?>"><?php echo $this->lang->line('read'); ?></a></li>
...
<?php echo form_open(current_url().'?a=delete&amp;rel_id='.$rel->itm_id.'&amp;itm_id='.$itm->itm_id); ?>
