...
<ul>
<li><a href="<?php echo current_url(); ?>?a=update&amp;lng_id=<?php echo $lng->lng_id; ?>"><?php echo $this->lang->line('update'); ?></a></li>
<li><a href="<?php echo current_url(); ?>?a=read&amp;lng_id=<?php echo $lng->lng_id; ?>"><?php echo $this->lang->line('read'); ?></a></li>
...
<?php echo form_open(current_url().'?a=delete&amp;lng_id='.$lng->lng_id); ?>
