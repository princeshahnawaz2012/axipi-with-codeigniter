...
<li><a href="<?php echo base_url(); ?><?php echo $this->itm->itm_code; ?>/_read/?grp_id=<?php echo $grp->grp_id; ?>"><?php echo $this->lang->line('read'); ?></a></li>
...
<?php echo form_open(current_url().'?grp_id='.$grp->grp_id); ?>
