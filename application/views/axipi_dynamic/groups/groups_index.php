...
<thead>
<tr>
<?php display_column(base_url().$this->itm->itm_code, 'groups', $columns[0], $this->lang->line('grp_id')); ?>
<?php display_column(base_url().$this->itm->itm_code, 'groups', $columns[1], $this->lang->line('grp_code')); ?>
<?php display_column(base_url().$this->itm->itm_code, 'groups', $columns[2], $this->lang->line('permissions')); ?>
<?php display_column(base_url().$this->itm->itm_code, 'groups', $columns[3], $this->lang->line('items')); ?>
<?php display_column(base_url().$this->itm->itm_code, 'groups', $columns[4], $this->lang->line('users')); ?>
<th>&nbsp;</th>
</tr>
</thead>
<tbody>
...
<tr>
<td><a href="<?php echo base_url(); ?><?php echo $this->itm->itm_code; ?>/_read/<?php echo $result->grp_id;?>"><?php echo $result->grp_id;?></a></td>
...
<th>
<a href="<?php echo base_url(); ?><?php echo $this->itm->itm_code; ?>/_update/<?php echo $result->grp_id;?>"><?php echo $this->lang->line('update'); ?></a>
<?php if($result->count_items == 0 && $result->grp_islocked == 0) { ?><a href="<?php echo base_url(); ?><?php echo $this->itm->itm_code; ?>/_delete/<?php echo $result->grp_id;?>"><?php echo $this->lang->line('delete'); ?></a><?php } ?>
</th>
</tr>
<?php } ?>
