...
<div class="box1">
<h1><?php echo $this->lang->line('zones'); ?></h1>
<ul>
...
<div class="filters">
<div><?php echo form_label($this->lang->line('zon_code'), 'zones_zon_code'); ?><?php echo form_input('zones_zon_code', set_value('zones_zon_code', $this->session->userdata('zones_zon_code')), 'class="inputtext"'); ?></div>
